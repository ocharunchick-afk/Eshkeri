# -*- coding: utf-8 -*-
# PyInstaller version info resource for Eshkeri.exe
            ...
            [
                StringTable(
                    ...
                    [
                        ...
                        StringStruct('FileDescription', 'Eshkeri Protocol — by smuggi_san'),
                        StringStruct('FileVersion', '2.7.0.0'),
                        StringStruct('InternalName', 'Eshkeri'),
                        StringStruct('LegalCopyright', '© 2026 smuggi_san. All rights reserved.'),
                        StringStruct('OriginalFilename', 'Eshkeri.exe'),
