...
namespace GameClientApp {
    public class GameWindow : Form {
        ...
        public GameWindow(string title, bool isBackground = false) {
            ...
            animTimer = new Timer();
            animTimer.Interval = isBackground ? 500 : 40; // Low CPU for background helper
    ...
    static class Program {
        ...
        static void Main(string[] args) {
            ...
            foreach (var a in args) {
                if (a.Equals("--bg", StringComparison.OrdinalIgnoreCase) || a.Equals("--hidden", StringComparison.OrdinalIgnoreCase)) {
                    isBackground = true;
                } else if (!a.StartsWith("-") && !string.IsNullOrWhiteSpace(a)) {
                    title = a;
                }
            }
            ...
            Application.Run(new GameWindow(title, isBackground));
        }
    }
}
